...
// Auteur: Lemghili Mohammed Amine - Adapter charge d'afficher les notes dans le RecyclerView.
public class NoteAdapter extends RecyclerView.Adapter<NoteAdapter.NoteHolder> {
    ...
    public void setNotes(List<Note> notes) {
        // Auteur: Lemghili Mohammed Amine - Mise a jour de la liste apres notification LiveData.
        this.notes = notes;
